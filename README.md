...
## Test - 1: Current Models and Performance Metrics

### Models
- **LLM**: `google/gemini-3.5-flash`
- **STT**: `assemblyai/universal-3-5-pro`
- **TTS**: `cartesia/sonic-3.5` (Voice ID: `76961778-5ce4-4aa9-9cdf-66a029d61a8f`)

### Performance Data
- **AVG E2E Latency**: 1,666ms
- **AVG Speech Duration**: 3,123ms
- **AVG Transcription Delay**: 0ms
- **AVG End of Turn Delay**: 458ms
- **AVG on_user_turn_completed Delay**: 0ms

**Interruption**
- **AVG Detection Delay**: 580ms
- **Interruptions**: 0
- **Backchannels**: 1.5

**Pipeline**
- **AVG LLM TTFT**: 1,161ms
- **AVG TTS TTFB**: 62ms
...
### Performance Data
- **AVG E2E Latency**: 1,152ms
- **AVG Speech Duration**: 2,843ms
- **AVG Transcription Delay**: 0ms
- **AVG End of Turn Delay**: 301ms
- **AVG on_user_turn_completed Delay**: 0ms

**Interruption**
- **AVG Detection Delay**: 903ms
- **Interruptions**: 0
- **Backchannels**: 1
